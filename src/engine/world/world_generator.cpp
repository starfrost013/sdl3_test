...
{ 
    ...
    */
    ...
    void WorldGenerator::Init(Vector2<int32_t> size)
    {
    ...
    void WorldGenerator::CreateGenerateNoise()
    {
    ...
    void WorldGenerator::CreateGenerateWorld()
    {
        /* 
            optimisation:
    ...
    void WorldGenerator::CreateGenerateQuadtree()
    {
